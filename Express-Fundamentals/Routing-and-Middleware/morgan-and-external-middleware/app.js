...
const morgan = require('morgan');   // morgan is a logger package for express 

const userRoutes = require('./userRoutes');

app.use(express.json());
// app.use(middleware.logger); // Uses the middleware in middleware.js
app.use(morgan('dev')); // Instead of writing our own logger, we will use a more robust one called morgan
